...
import jpa.session.MarcamaterialFacade;
...
public class MarcamaterialController implements Serializable {
    ...
    @EJB
    private jpa.session.MarcamaterialFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("MarcamaterialCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("MarcamaterialUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("MarcamaterialDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Marcamaterial getMarcamaterial(java.lang.Short id) {
