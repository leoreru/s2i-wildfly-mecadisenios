...
import jpa.session.TipodocumentoFacade;
...
public class TipodocumentoController implements Serializable {
	...
	@EJB
	private jpa.session.TipodocumentoFacade ejbFacade;
	...
	public void create() {
		persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("TipodocumentoCreated"));
	...
	public void update() {
		persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("TipodocumentoUpdated"));
	}

	public void destroy() {
		persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("TipodocumentoDeleted"));
		if (!JsfUtil.isValidationFailed()) {
