...
import jpa.session.PersonajuridicaFacade;
...
public class PersonajuridicaController implements Serializable {
	...
	@EJB
	private jpa.session.PersonajuridicaFacade ejbFacade;
	...
	public void create() {
		persist(PersistAction.CREATE, ResourceBundle.getBundle("resources/Bundle").getString("PersonajuridicaCreated"));
	...
	public void update() {
		persist(PersistAction.UPDATE, ResourceBundle.getBundle("resources/Bundle").getString("PersonajuridicaUpdated"));
	}

	public void destroy() {
		persist(PersistAction.DELETE, ResourceBundle.getBundle("resources/Bundle").getString("PersonajuridicaDeleted"));
		if (!JsfUtil.isValidationFailed()) {
